...
def spatial_vqa_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "libero_union3": libero_dataset_transform,
    "libero_union4": libero_dataset_transform,

    "libero_core_full": libero_dataset_transform,
    "libero_core_lt": libero_dataset_transform,
    "libero_spatial_lt": libero_dataset_transform,
    "libero_spatial_lt_balanced": libero_dataset_transform,
    "libero_spatial_lt_tempered": libero_dataset_transform,
    "libero_core_apa": libero_dataset_transform,
}

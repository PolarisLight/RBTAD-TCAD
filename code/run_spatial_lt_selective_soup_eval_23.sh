...
ALPHA=${ALPHA:-0.5}
STEP=${STEP:-100}
PROBE_NAME=${PROBE_NAME:-spatial_lt_selective_soup}
...

{
  ...
  make_soup "rsdf_barc100_llmproj_a${ALPHA//./p}" "llm_backbone,projector"
  make_soup "rsdf_barc100_projector_a${ALPHA//./p}" "projector"
  run_eval "rsdf_barc100_llmproj_a${ALPHA//./p}" "rsdf_llmproj"
  run_eval "rsdf_barc100_projector_a${ALPHA//./p}" "rsdf_projector"

...
\begin{table}[t]
  \centering
  \caption{Controlled counterpart results outside the main \liberocorelt{} benchmark. \liberocorefull{} uses 50 rollouts per task. \liberospatiallt{} uses matched 30-rollout-per-task evaluations under the same checkpoint budget; two seeds are shown because the second seed weakens the RSDF claim.}
  \label{tab:controlled_full}
  \begin{tabular}{lllc}
    \toprule
    Dataset & Seed & Method & Success rate \\
    \midrule
    \multirow{2}{*}{\liberocorefull{}}
      & 7 & BC baseline & 43.0\% \\
      & 7 & TCAD-trained & \textbf{50.0\%} \\
    \midrule
    \multirow{4}{*}{\liberospatiallt{}}
      & 7 & BC baseline & 19.0\% \\
      & 7 & RSDF vision+LLM & \textbf{25.0\%} \\
      & 13 & BC baseline & 17.0\% \\
      & 13 & RSDF vision+LLM & 18.0\% \\
    \bottomrule
  \end{tabular}
\end{table}
